...
//AM I MISSING A LINE HERE?  I DON'T SEE THE ARROW FUNCTION, JUST A CONSOLE LOG.
console.log(joe);

// TODO: After viewing the previous console.log(), return the code to a working state.
// THE CODE IS WORKING ERROR FREE AT THIS TIME.  I DON'T UNDERSTAND THE REQUEST.
...
//AGAIN, NOTHING SEEMS BROKE TO ME.  WHAT AM I MISSING?
...
//  I know to say that its the owner of of the function (the object that defined the arrow function) but I don't fully understand what that means.

// 3. Explain why "this" is different when an arrow function is used.
//  I know to say that there is no binding of "this" when an arrow function is used but I don't fully understand what that means.
